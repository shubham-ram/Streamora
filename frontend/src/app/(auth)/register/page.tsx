    ...
    <Card className="bg-surface-primary/80 backdrop-blur-xl border-border-main shadow-2xl">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription className="text-fg-secondary">
          Join StreamHub and start streaming
        </CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="username" className="text-fg-secondary">
              Username
            </Label>
            <Input
              id="username"
              ...
              minLength={3}
              maxLength={20}
              className="bg-surface-secondary/50 border-border-subtle text-fg-primary placeholder:text-fg-muted"
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="confirmPassword" className="text-fg-secondary">
              Confirm Password
            </Label>
            <Input
              id="confirmPassword"
