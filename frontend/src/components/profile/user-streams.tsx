    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {liveStream && (
        <div className="mb-8">
          ...
          <Link
            href={`/watch/${username}`}
            className="block p-4 bg-gradient-to-r from-purple-900/50 to-blue-900/50 border border-purple-500/30 rounded-xl hover:border-purple-500/60 transition-colors"
          >
      ...
      {/* Past Streams */}
      <div>
        <h2 className="text-xl font-bold text-white mb-4">Past Streams</h2>
